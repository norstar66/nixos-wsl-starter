...
in {
  ...
  programs = {
    ...
    git = {
      ...
      userEmail = "norstar1983@gmail.com"; # set git email
      userName = "norstat66"; # set git username
      extraConfig = {
    ...
    fish = {
      ...
      code = "/mnt/c/Users/Norstar/AppData/Local/Programs/'Microsoft VS Code'/bin/code";
      };
      plugins = [
        {
